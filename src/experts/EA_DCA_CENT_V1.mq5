...
//| (see GO_LIVE_VALIDATION_PLAN.md). Byte-identical trading logic to  |
//| DCA_EA.mq5 as of commit dccf97b (post PNL_DISCREPANCY_ROOT_CAUSE   |
//| Finding 2 fix + the InpAlwaysCloseOnOppositeBand OnInit notice).   |
